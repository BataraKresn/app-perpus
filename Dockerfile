...
COPY ./app-perpus /var/www/html/app-perpus/
...
RUN	\
	...
	&& chown www-data:www-data /var/www/html/app-perpus/ -Rf \
	# Cleaning
...
COPY ./configs/app.conf ${NGINX_CONF_DIR}/sites-enabled/app-perpus.conf
COPY ./configs/www.conf /etc/php/7.2/fpm/pool.d/www.conf

WORKDIR /var/www/html/app-perpus/
